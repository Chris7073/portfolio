    ...
    defineProps<{
      blockData: TextBlockData; // o genericamente Object se la struttura varia molto
    }>();
</script>
<template>
  <section class="bg-white dark:bg-slate-900 py-20 sm:py-28 lg:py-32 px-6 sm:px-8">
